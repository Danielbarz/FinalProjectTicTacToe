...
public class Connect4Vs extends JFrame {
    ...
    public Connect4Vs() {
        ...
        vsai.setPreferredSize(new Dimension(310, 130));
        ...
        players.setPreferredSize(new Dimension(430, 130));
        ...
        gbc.gridx = 2;
        gbc.gridy = 3;
        gbc.insets = new Insets(10, -250, 110, 100);
        controlsPanel.add(vsai, gbc);

        // Tombol 2 Players
        gbc.gridx = 3;
        gbc.gridy = 3;
        gbc.insets = new Insets(10, 0, 110, -90);
        controlsPanel.add(players, gbc);

        // Tombol Back
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.insets = new Insets(0, 0, 250, 155); // Sesuaikan posisi
